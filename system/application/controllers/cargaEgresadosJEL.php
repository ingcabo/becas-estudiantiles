...
class cargaEgresadosJEL extends Controller
{

  function cargaEgresadosJEL()
  {
  ...
  function cargaEgresadosJELControl()
  {
    ...
    $this->load->view('carga/cargaEgresadosJELForm', $data);
  }

  
  function cargaEgresadosJELRecord()
  {
    $row = 6;
    ...
    if ( ! $this->upload->do_upload())
		{
			...
			$this->load->view('carga/cargaEgresadosJELForm', $dataView);
		}
		else
		{
      ...
      $dataView['returnPage'] ='cargaEgresadosJEL/cargaEgresadosJELControl';
      $dataView['titulo'] ='Carga de Estudiantes Egresados JEL';
      ...
      $dataView['errorMsg'] = '';
      $dataView['outputFilename'] = 'EgreJEL_('.$reg->siglas_instituto.')_'.date("Y-m-d_H-i-s").'.log';
      ...
      while($tipoCedulaPersona != '')
      {
        ...
        $result = $this->cargaModel->insertEgresadoJEL($dataView['tipoCedulaPersona'], $dataView['cedulaPersona'],
