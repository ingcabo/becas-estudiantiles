...
class cargaEgresadosNOJEL extends Controller
{

  function cargaEgresadosNOJEL()
  {
  ...
  function cargaEgresadosNOJELControl()
  {
    ...
    $this->load->view('carga/cargaEgresadosNOJELForm', $data);
  }

  
  function cargaEgresadosNOJELRecord()
  {
    $row = 6;
    ...
    if ( ! $this->upload->do_upload())
		{
			...
			$this->load->view('carga/cargaEgresadosNOJELForm', $dataView);
		}
		else
		{
      ...
      $dataView['returnPage'] ='cargaEgresadosNOJEL/cargaEgresadosNOJELControl';
      $dataView['titulo'] ='Carga de Estudiantes Egresados NO JEL';
      ...
      $dataView['errorMsg'] = '';
      $dataView['outputFilename'] = 'EgreNOJEL_('.$reg->siglas_instituto.')_'.date("Y-m-d_H-i-s").'.log';
      ...
      while($tipoCedulaPersona != '')
      {
        ...
        $result = $this->cargaModel->insertEgresadoNOJEL($dataView['tipoCedulaPersona'], $dataView['cedulaPersona'],
