...
class con_rep_beneficiario extends Controller{
     ...
     function con_rep_beneficiario() {
            ...
            // $this -> load  ->model('Model_beneficiario','',TRUE);
         

             $this -> load  ->helper(array('form', 'url'));
             $this -> load  ->helper('phpexcelhelper');
...
$criterio_spromediodp  = $_POST['spromediodp'];
if(isset($_POST['promediodp']) && $_POST['promediodp'] <> ''){

    $promediodp =  $_POST['promediodp'];
}
...
$objPHPExcel->getActiveSheet()->SetCellValue('F'.$indice,'Promedio C');
$objPHPExcel->getActiveSheet()->SetCellValue('G'.$indice,'Promedio D');
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$indice,'Estatus');
...
$objPHPExcel->getActiveSheet()->SetCellValue('A'.$indice2,'TOTAL conjunto');

//******************************************


//*******************************************************
  $data['archivo']='beneficiario.xls';
...
$objWriter->save('Reportes/beneficiario.XLS');
