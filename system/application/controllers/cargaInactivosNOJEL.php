...
class cargaInactivosNOJEL extends Controller
{

  function cargaInactivosNOJEL()
  {
  ...
  function cargaInactivosNOJELControl()
  {
    ...
    $this->load->view('carga/cargaInactivosNOJELForm', $data);
  }


  function cargaInactivosNOJELRecord()
  {
    $row = 6;
    ...
    if ( ! $this->upload->do_upload())
		{
			...
			$this->load->view('carga/cargaInactivosNOJELForm', $dataView);
		}
		else
		{
      ...
      $dataView['returnPage'] ='cargaInactivosNOJEL/cargaInactivosNOJELControl';
      $dataView['titulo'] ='Carga de Estudiantes Inactivos NO JEL';
      ...
      $dataView['errorMsg'] = '';
      $dataView['outputFilename'] = 'InactNOJEL_('.$reg->siglas_instituto.')_'.date("Y-m-d_H-i-s").'.log';
      ...
      while($tipoCedulaPersona != '')
      {
        ...
        $result = $this->cargaModel->insertInactivoNOJEL($dataView['tipoCedulaPersona'], $dataView['cedulaPersona'],
