...
class cargaInactivosJEL extends Controller
{

  function cargaInactivosJEL()
  {
  ...
  function cargaInactivosJELControl()
  {
    ...
    $this->load->view('carga/cargaInactivosJELForm', $data);
  }


  function cargaInactivosJELRecord()
  {
    $row = 6;
    ...
    if ( ! $this->upload->do_upload())
		{
			...
			$this->load->view('carga/cargaInactivosJELForm', $dataView);
		}
		else
		{
      ...
      $dataView['returnPage'] ='cargaInactivosJEL/cargaInactivosJELControl';
      $dataView['titulo'] ='Carga de Estudiantes Inactivos JEL';
      ...
      $dataView['errorMsg'] = '';
      $dataView['outputFilename'] = 'InactJEL_('.$reg->siglas_instituto.')_'.date("Y-m-d_H-i-s").'.log';
      ...
      while($tipoCedulaPersona != '')
      {
        ...
        $result = $this->cargaModel->insertInactivoJEL($dataView['tipoCedulaPersona'], $dataView['cedulaPersona'],
