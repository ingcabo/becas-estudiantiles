...
//require_once 'system/application/my_classes/Classes/PHPExcel/Cell/DataValidation.php';
require_once 'Cell/DataValidation.php';

/** PHPExcel_Cell_Hyperlink */
//require_once base_url().'system/application/my_classes/Classes/PHPExcel/Cell/Hyperlink.php';
require_once 'Cell/Hyperlink.php';

/** PHPExcel_Worksheet */
//require_once base_url().'system/application/my_classes/Classes/PHPExcel/Worksheet.php';
require_once 'Worksheet.php';

/** PHPExcel_Calculation */
//require_once 'system/application/my_classes/Classes/PHPExcel/Calculation.php';
require_once 'Calculation.php';

/** PHPExcel_Cell_IValueBinder */
//require_once base_url().'system/application/my_classes/Classes/PHPExcel/Cell/IValueBinder.php';
require_once 'Cell/IValueBinder.php';

/** PHPExcel_Cell_DefaultValueBinder */
//require_once (base_url().'system/application/my_classes/Classes/PHPExcel/Cell/DefaultValueBinder.php');
