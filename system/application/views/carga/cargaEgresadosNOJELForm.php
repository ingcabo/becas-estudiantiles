...
<html>
<head>
<title>Carga de Alumnos Egresados NO JEL</title>
...
<body>
<?php echo $menu; ?>
<p align="center" class="Titulo"><br>Carga de Alumnos Egresados NO JEL</p>


<?php echo form_open_multipart('cargaEgresadosNOJEL/cargaEgresadosNOJELRecord');?>
  ...
  <table width="634" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
     ...
     <tr>
      ...
      <tr>
        <td width="343" class="celda">
        <strong>
        Archivo de Información Egresados NO JEL: <span class="fontnormal"><font color="#FF0000">   </font></span>        </strong>        </td>
     </tr>
     <tr>
        <td bgcolor="#FFFFFF">
	  	  <div align="left">
