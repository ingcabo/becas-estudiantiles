...
<html>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script>
     <title>Control de Aspirantes</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <?php $editRecord='aspirante/aspiranteForm'; ?>
    <?php $listRecord='aspirante/aspiranteControl'; ?>
    <?php $deleteRecord='aspirante/aspiranteDelete'; ?>
    ...
    <p align="center" class="Titulo">Control de Aspirantes</p>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      <tr>
        ...
        Procedencia (Tipo, Fecha, Lugar)        </td>
      ...
      ?>
          <tr>
            ...
            <?php
            if($permisos['b'])
              echo anchor($deleteRecord.'/'.$row->procedencia_persona_id,
