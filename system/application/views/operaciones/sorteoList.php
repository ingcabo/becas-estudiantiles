...
-->
  ...
  <body>
    ...
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="E9E8E2">
      ...
      <tr>
        <td colspan="<?php echo $colSpanFullLine; ?>" align="right" bgcolor="E9E8E2">
          <?php
          if($permisos['i'])
      ...
      <tr>
        ...
        <td class="celdaTitulo" width="24%">
        Fecha        </td>
        <td class="celdaTitulo" width="12%">        </td>
        <td class="celdaTitulo" width="24%">&nbsp;        </td>
      ...
      ?>
          <tr>
            ...
            <?php echo($row->lugar_sorteo); ?>            </td>
            <td class="celdaContenido">
            <?php echo($this->jelgeneral->arreglarFechaBD($row->fecha_sorteo));?>            </td>
            <td class="celdaContenido">
            <?php // echo($row->fecha_sorteo);?>            </td>
            <td class="celdaContenido">
            <?php // echo($row->fecha_sorteo);?>            </td>
