...
<html>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script>
     <title>Control de Beneficiarios</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <?php $editRecord='beneficiario/beneficiarioForm'; ?>
    <?php $listRecord='beneficiario/beneficiarioControl'; ?>
    <?php $deleteRecord='beneficiario/beneficiarioDelete'; ?>
    ...
    <p align="center" class="Titulo">Control de Beneficiarios</p>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      ?>
          <tr>
            <td class="celdaContenido" width="28%">
            <?php echo($row->apellido_persona.' '.$row->nombre_persona);?>            </td>
            ...
            <?php echo($this->jelgeneral->arreglarFechaBD($row->fecha_ingreso)); ?>            </td>
            ...
            <?php
            if($permisos['b'])
              echo anchor($deleteRecord.'/'.$row->beca_persona_id,
