...
<html>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script>
    <title>Control de Modalidades</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <br>
    <?php echo form_open('modalidad/modalidadControl'); ?>
    <input type="hidden" id="bandPost" name="bandPost" value="1">
   

    <p align="center" class="Titulo">Control de Modalidades</p>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      <tr>
        <td colspan="<?php echo $colSpanFullLine; ?>" align="right">
          <?php
          echo anchor('modalidad/modalidadForm/-1','<img alt="Agregar" src="'.base_url().'system/application/views/imagenes/agregar.png" border="0">');
          ?>        </td>
      </tr>

      <tr>
        <td class="celdaTitulo" width="46%">
        Nombre de la Modalidad        </td>
      ...
      ?>
          <tr>
            ...
            <td class="celdaContenido"><?php echo($row->descripcion_modalidad); ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
            echo anchor('modalidad/modalidadForm/'.$row->modalidad_id,
                        '<img alt="Modificar" src="'.base_url().'system/application/views/imagenes/modificar.png" border="0">');
            ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
            echo anchor('modalidad/modalidadDelete/'.$row->modalidad_id,
