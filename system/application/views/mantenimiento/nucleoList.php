...
<html>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script> 
    <title>Control de Nucleos</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <br>
    <?php echo form_open('nucleo'); ?>
    <input type="hidden" id="bandPost" name="bandPost" value="1">
   

    <p align="center" class="Titulo">Control de Núcleos</p>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      <tr>
        ...
        <select name="cmbCampo" id="cmbCampo" style="width:200px">
          ...
          <option value="nombre_nucleo_instituto" <?php if($campo=="nombre_nucleo_instituto") echo 'selected';?> >Nombre Núcleo</option>
          <option value="siglas_nucleo_instituto" <?php if($campo=="siglas_nucleo_instituto") echo 'selected';?> >Siglas del Núcleo</option>
        </select>
      ...
      <tr>
        <td colspan="<?php echo $colSpanFullLine; ?>" align="right">
          <?php
          if($permisos['i'])
            echo anchor('nucleo/nucleoForm/-1','<img alt="Agregar" src="'.base_url().'system/application/views/imagenes/agregar.png" border="0">');
          ?>        </td>
      </tr>

      <tr>
        <td class="celdaTitulo" width="42%">Nombre del Instituto </td>
        <td class="celdaTitulo" width="20%">
        Nombre Núcleo        </td>       
        <td class="celdaTitulo" width="22%">
        Siglas del Núcleo        </td>
      ...
      ?>
          <tr>
            ...
            <td class="celdaContenido">
            <?php echo($row->nombre_nucleo_instituto); ?>            </td>
            <td class="celdaContenido">
            <?php echo($row->siglas_nucleo_instituto);?>            </td>
            <td align="center" class="celdaContenido">
            <?php
            if($permisos['m'])
              echo anchor('nucleo/nucleoForm/'.$row->nucleo_instituto_id,
                        '<img alt="Modificar" src="'.base_url().'system/application/views/imagenes/modificar.png" border="0">');
            ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
            if($permisos['b'])
              echo anchor('nucleo/nucleoDelete/'.$row->nucleo_instituto_id,
