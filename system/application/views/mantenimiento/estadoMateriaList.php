...
<html>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script>
    <title>Control de Estados de Materias</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <br>
    <?php echo form_open('estadoMateria/estadoMateriaControl'); ?>
    <input type="hidden" id="bandPost" name="bandPost" value="1">
   

    <p align="center" class="Titulo">Control de Estados de Materias</p>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      <tr>
        ...
        <select name="cmbCampo" id="cmbCampo" style="width:200px">
          <option></option>
          <option value="nombre_estado_materia" <?php if($campo=="nombre_estado_materia") echo 'selected';?> >Estado de Materia</option>
        </select>
      ...
      <tr>
        <td colspan="<?php echo $colSpanFullLine; ?>" align="right">
          <?php
           if($permisos['i'])
             echo anchor('estadoMateria/estadoMateriaForm/-1','<img alt="Agregar" src="'.base_url().'system/application/views/imagenes/agregar.png" border="0">');
          ?>        </td>
      </tr>

      <tr>
        <td class="celdaTitulo" width="46%">
        Nombre del Estado de la Materia        </td>
      ...
      ?>
          <tr>
            ...
            <?php echo($row->nombre_estado_materia); ?>            </td>
            <td class="celdaContenido">
            <?php echo($row->descripcion_estado_materia); ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
             if($permisos['m'])
              echo anchor('estadoMateria/estadoMateriaForm/'.$row->estado_materia_id,
                        '<img alt="Modificar" src="'.base_url().'system/application/views/imagenes/modificar.png" border="0">');
            ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
             if($permisos['b'])
               echo anchor('estadoMateria/estadoMateriaDelete/'.$row->estado_materia_id,
