...
<html>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script>
    <title>Control de Estados de Personas</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <br>
    <?php echo form_open('estadoPersona/estadoPersonaControl'); ?>
    <input type="hidden" id="bandPost" name="bandPost" value="1">
   

    <p align="center" class="Titulo">Control de Estados de Personas</p>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      <tr>
        ...
        <select name="cmbCampo" id="cmbCampo" style="width:200px">
          <option></option>
          <option value="nombre_estado_persona" <?php if($campo=="nombre_estado_persona") echo 'selected';?> >Estado de Persona</option>
        </select>
      ...
      <tr>
        <td colspan="<?php echo $colSpanFullLine; ?>" align="right">
          <?php
          if($permisos['i'])
            echo anchor('estadoPersona/estadoPersonaForm/-1','<img alt="Agregar" src="'.base_url().'system/application/views/imagenes/agregar.png" border="0">');
          ?>        </td>
      </tr>

      <tr>
        <td class="celdaTitulo" width="83%">
        Estado de Persona        </td>      
      ...
      ?>
          <tr>
            ...
            <?php
            if($permisos['m'])
              echo anchor('estadoPersona/estadoPersonaForm/'.$row->estado_persona_id,
                        '<img alt="Modificar" src="'.base_url().'system/application/views/imagenes/modificar.png" border="0">');
            ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
            if($permisos['b'])
              echo anchor('estadoPersona/estadoPersonaDelete/'.$row->estado_persona_id,
