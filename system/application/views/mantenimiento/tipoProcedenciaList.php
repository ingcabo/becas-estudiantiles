...
<html>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>system/application/views/javascript/validacion.js"></script>
    <title>Control de Tipos de Procedencias</title>
  <style type="text/css">
<!--
body {
...
-->
  ...
  <body>
    ...
    <br>
    <?php echo form_open('tipoProcedencia/tipoProcedenciaControl'); ?>
    <input type="hidden" id="bandPost" name="bandPost" value="1">
   

    <p align="center" class="Titulo">Control de Tipos de Procedencia</p><br>
    <table width="736px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9E8E2">
      ...
      <tr>
        <td colspan="<?php echo $colSpanFullLine; ?>" align="right">
          <?php
          if($permisos['i'])
            echo anchor('tipoProcedencia/tipoProcedenciaForm/-1','<img alt="Agregar" src="'.base_url().'system/application/views/imagenes/agregar.png" border="0">');
          ?>        </td>
      </tr>

      <tr>
        <td class="celdaTitulo" width="84%">
        Nombre del Tipo de Procedencia        </td>      
      ...
      ?>
          <tr>
            ...
            <?php
            if($permisos['m'])
              echo anchor('tipoProcedencia/tipoProcedenciaForm/'.$row->tipo_procedencia_id,
                        '<img alt="Modificar" src="'.base_url().'system/application/views/imagenes/modificar.png" border="0">');
            ?>            </td>
            <td align="center" class="celdaContenido">
            <?php
            if($permisos['b'])
              echo anchor('tipoProcedencia/tipoProcedenciaDelete/'.$row->tipo_procedencia_id,
