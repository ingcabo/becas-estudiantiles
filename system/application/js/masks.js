...
Mask.prototype.attach = function (o){
	...
	if( this.type == "number" ) this.value = this.setNumber(v, true);
	else if( this.type == "date" ) this.value = this.setDateKeyPress(v, true);
	else this.value = this.setGeneric(v, true);
